<?
        ...
        $fields_labels= array("accountsId","destacado","título Esp","título Cat","categoría","subcategoría","descripcion Esp","descripcion Cat","imagen","lugar","dirección","municipio","fecha evento","fecha fín","días semana","hora inicio","hora final","hora_inicio2","hora_final2","precio","precio anticipado","telf","email","web","confirmado y pagado","publicado","fecha_registro","Inicio Publicación","Final publicación");
