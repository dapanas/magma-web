...
$code='329324867';
$terminal='1';
$order=date('ymdHis'); // $ORDER DEBERIA SER ID DE(RESERVAS)
//$amount= $row['precio']."00";
$currency='978';
$transactionType='0';
$urlMerchant='http://www.publicaenmagma.es/produccion/web/tpv/asincro.php';
$producto="Magma Evento Destacado";
//$urlok = 'http://www.grupounipoker.com/?cat=tpvreturn&ok=1';
//$urlko = 'http://www.grupounipoker.com/?cat=tpvreturn&ok=0';
//$merchantdata = $iduser."-".$rew['id']."-".$id;
