...
<div class='inside'>
	<h2><?= $DATOS_CUENTA ?></h2>
	<div class="col" id="borde_dret" style="height: 280px;">
	...
	<div class="col" style="vertical-align:top;">
		<form class='form' id="formcambiarpassword" action='accounts/doEdit' method='POST' enctype='multipart/form-data'>
			...
			<input type="button" href="#modalcambiarpassword" class="button black" value="<?= $GUARDAR_T ?>" onclick="doForm(this.form);">
		</div>
	</form>
</div>
